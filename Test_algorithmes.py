...
prev_data_t, data_y = read("test.csv", 1, 15)
...
N = 100 # nb d'itérations
Nb = 50 # à partir de quand on prend en compte les z dans Sk
...
nuts, data_y_computed = complete_disease_NUTS(data_t_train, data_t_incomplete, data_t_complete, data_y_train, data_y_incomplete, param_nuts, theta_init)

compare_data(data_t_complete, data_y_complete, data_y_computed)
