...
eps = 0.002 # step_size
N = 200 # nb d'itérations
Nb = 100 # à partir de quand on prend en compte les z dans Sk
...
nuts = NUTS(data_t, data_y, theta_init, var_t0, var_p0, var_v0, nb_patients, nb_mesures, eps, N, Nb, beta, limit_j)
